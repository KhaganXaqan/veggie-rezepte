...
export const metadata: Metadata = generateSeoMetadata({
  title: 'Veggie-Rezepte - Vegetarische und Vegane Rezepte',
  description: 'Entdecke köstliche vegetarische und vegane Rezepte für jeden Tag. Einfach, gesund und lecker!',
  path: '/',
  type: 'website'
})
