...
export default function SalateRecipes() {
  ...
  useEffect(() => {
    ...
    metaKeywords.setAttribute('content', `${categoryName}, vegetarisch, rezepte, veggie rezepte, frisch, gesund, saisonal`);
  ...
  return (
    <>
      <Head>
        ...
        <meta name="keywords" content={`${categoryName}, vegetarisch, rezepte, veggie rezepte, frisch, gesund, saisonal`} />
