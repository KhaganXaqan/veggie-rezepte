...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const pageTitle = `${categoryName} Rezepte | Vegetarische Aufläufe & Gratins | Veggie Rezepte`;
  const pageDescription = `Entdecke ${recipeCount} herzhafte vegetarische ${categoryName} Rezepte. Von cremigen Gratins bis zu überbackenen Gemüsevariationen - Ofengerichte für die ganze Familie.`;
  
  return {
    title: pageTitle,
    description: pageDescription,
    keywords: `${categoryName}, vegetarische aufläufe, vegane aufläufe, gratins vegetarisch, überbackene gerichte, ofengerichte, familienrezepte, herzhafte aufläufe`,
    openGraph: {
      title: pageTitle,
      description: pageDescription,
      type: 'website',
...
export async function generateStructuredData() {
  ...
  return {
    ...
    description: `Vegetarische ${categoryName} Rezepte - herzhafte Ofengerichte für die ganze Familie`,
...
export default async function AuflaeufeRecipes() {
  const categoryRecipes = recipes.filter((recipe: Recipe) => recipe.category === categoryName)
  ...
  return (
    <>
      ...
      {structuredData && (
        <Script
          id="auflaeufe-category-structured-data"
          ...
          <div className="container py-8">
            <div className="max-w-2xl mx-auto mb-8">
              ...
              <p className="text-lg text-gray-600 mb-6">
                Entdecke {categoryRecipes.length} herzhafte vegetarische {categoryName} Rezepte. 
                Von cremigen Gratins bis zu überbackenen Gemüsevariationen – hier findest du Ofengerichte, die die ganze Familie begeistern.
              </p>
            </div>
          </div>
