...
export default function AuflaeufeRecipes() {
  ...
  const pageDescription = `Vegetarische ${categoryName} sind perfekt zum Vorbereiten und bieten wunderbare Aromen-Kombinationen für die ganze Familie.`;
  ...
  useEffect(() => {
    ...
    metaKeywords.setAttribute('content', `${categoryName}, vegetarisch, rezepte, veggie rezepte, kochen, gesund, einfach`);
  ...
  return (
    <>
      <Head>
        ...
        <meta name="keywords" content={`${categoryName}, vegetarisch, rezepte, veggie rezepte, kochen, gesund, einfach`} />
