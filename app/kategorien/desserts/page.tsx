...
export default function DessertsRecipes() {
  ...
  useEffect(() => {
    ...
    metaKeywords.setAttribute('content', `${categoryName}, vegetarisch, süßspeisen, nachtisch, veggie rezepte, süß, einfach`);
  ...
  return (
    <>
      <Head>
        ...
        <meta name="keywords" content={`${categoryName}, vegetarisch, süßspeisen, nachtisch, veggie rezepte, süß, einfach`} />
